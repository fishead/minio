...
func (l *ossObjects) StorageInfo(ctx context.Context) (si madmin.StorageInfo, _ []error) {
	si.Backend.Type = madmin.Gateway
	host := l.Client.Config.Endpoint
...
func (l *ossObjects) DeleteObject(ctx context.Context, bucket string, object string, opts minio.ObjectOptions) (minio.ObjectInfo, error) {
...
func (l *ossObjects) DeleteObjects(ctx context.Context, bucket string, objects []minio.ObjectToDelete, opts minio.ObjectOptions) ([]minio.DeletedObject, []error) {
	deletedObjects := make([]minio.DeletedObject, len(objects))
	errs := make([]error, len(objects))
	for idx, object := range objects {
		_, errs[idx] = l.DeleteObject(ctx, bucket, object.ObjectName, opts)
		if errs[idx] == nil {
			deletedObjects[idx] = minio.DeletedObject{
...
func (l *ossObjects) IsReady(ctx context.Context) bool {
	return minio.IsBackendOnline(ctx, l.Client.Config.Endpoint)
}
